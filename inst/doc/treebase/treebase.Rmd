...
facilitates identifying all potential data which meets certain desired
attributes.  For instance, one can quickly identify candidate phylogenies
consisting of a Species tree with over 200 taxa appearing in the journal
_Science_, using the R's sub-setting syntax
