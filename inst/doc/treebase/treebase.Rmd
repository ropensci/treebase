...
the `metadata_table` function, which combines information from both of the 
TreeBASE APIs.  
...
Table: Columns of metadata avialable from the `metadata_table` function 




publication metadata is accessed by the `search_metadata` function, 
