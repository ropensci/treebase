...
% \SweaveOpts{fig=TRUE, external=TRUE, cache=TRUE, message=FALSE, warning=FALSE, tidy=TRUE, dev=pdf, echo=TRUE}
...
These methods include tasks such as ancestral state reconstruction~\citep{Paradis2004, Butler2004}, diversification analysis~\citep{Stadler2011, FitzJohn2011, Rabosky2009}, trait evolution~\citep{Revell2011, Eastman2011, Butler2004, Paradis2004, Hipp2009, Jombart2010}, community ecology~\citet{Webb2008, Kembel2010}, phyloclimatic modelling~\citep{Evans2009, Warren2008}, simulation of phylogenies, as well as various manipulation and visualization of phylogenetic data~\citet{Revell2011, Paradis2004}.  


much of the analysis based %% DESCRIBE applied phylogenetics with citations! 
...
We can also look for patterns among publishers, 
such as how many different journals have contributed: 
<<journals, cache=FALSE>>=
pub <- sapply(metadata, `[[`, "publisher")
pub_table <- sort(table(unlist(pub)), decreasing=TRUE)
length(pub_table)
@
and which are responsible for the most phylogenies:  
<<topjournals, cache=FALSE>>=
head(pub_table)
@
